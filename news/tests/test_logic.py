...
class TestCommentEditDelete(TestCase):
    ...
    def test_user_cant_comment_of_another_user(self):
    ...
    def test_write_message_count_comment(self):
        comments_count = Comment.objects.count()
        self.assertEqual(comments_count, 1)
